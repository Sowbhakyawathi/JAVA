create table Empl(empno int, ename varchar(100), job varchar(100), mgr int, hiredate date, sal float, comm float, deptno int);
select * from empl;
...
Insert into empl (empno, ename, job, mgr, hiredate, sal, comm, deptno)values
 ...
 (8521, 'MAHADEVAN', 'MANAGER', 8839, '1991-04-02', 2985.00, NULL, 20),
 (8654, 'MOMIN', 'SALESMAN', 8698, '1991-09-28', 1250.00, 1400.00, 30),
 (8698, 'BINA', 'MANAGER', 8839, '1991-05-01', 2850.00, NULL, 30),
 (8882, 'SHIVANSH', 'MANAGER', 8839, '1991-06-09', 2450.00, NULL, 10),
 (8888, 'SCOTT', 'ANALYST', 8566, '1992-12-09', 3000.00, NULL, 20),
 (8839, 'AMIR', 'PRESIDNET', NULL,'1991-11-18', 5000.00, NULL, 10),
